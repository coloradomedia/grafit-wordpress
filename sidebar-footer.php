...
<div class="footer-container container-fluid">
	<div class="footer-row row justify-content-center">
		<div class="col-xs-12 col-md-6 col-lg-5 footer-widget open-footer">
			<h3>Godziny Otwarcia</h3>
			<div class="open-footer">Poniedziałek-Piątek: 8:00-17:00 <br> Sobota: 8:00-14:00</div>
		</div>
		<div class="col-xs-12 col-sm-6 col-md-6 col-lg-2 footer-widget">
			<?php dynamic_sidebar( 'footer-2' ); ?>
		</div>
		<div class="col-xs-12 col-sm-6 col-md-6 col-lg-2 footer-widget">
			<?php dynamic_sidebar( 'footer-3' ); ?>
		</div>
		<div class="col-xs-12 col-md-6 col-lg-3 footer-widget contact-footer">
