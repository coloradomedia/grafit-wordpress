    ...
    <div class="hits-container single-post-content animated fadeIn">
        <div class="row">
            ...
            <div class="col-md-7 single-post-text product-content">
                ...
                <div class="note">Podana specyfikacja ma charakter poglądowy. Pojemność dysku jak i pamięci RAM może zostać zwiększona lub zmniejszona zgodnie z oczekiwaniami.</div>
            </div>
        </div>
    </div>
</article>